...
[_QWERTY] = LAYOUT_60_iso( /* Base layer */
    ...
    KC_LCTL,  KC_LAPO,   KC_LCMD,                      LT(_NAV, KC_SPC),                MO(_SYMB),KC_RAPC,  TG(_NAV),KC_RCTL),
...
[_SYMB] = LAYOUT_60_iso( /* Symbol layer */
    ...
    KC_TRNS,  KC_LEFT,  KC_DOWN,  KC_RGHT,  S1_DEC,   S1_INC,   S2_DEC,   S2_INC,   KC_TRNS,  KC_TRNS,  KC_TRNS,  A(KC_2),  KC_TRNS,  KC_TRNS,\
